...
****************************************************************************/
	...
	$ini = parse_ini_file("/hp/libs/site.ini");
	$revision = $ini["rev"];
	$_SESSION["auth"] = 0;
	$_SESSION["user"] = "";
	$_SESSION["username"] = "";
...
?>
  ...
  <html lang="en">
    <head>
      ...
      <title>Login</title>
        <!--<link rel="icon" href="/hp/img/favicon.png">-->
        <link rel="stylesheet" href="/hp/bootstrap/css/bootstrap.min.css">
        <link href="/hp/css/login.min.css" rel="stylesheet">
    </head>
    <body>
